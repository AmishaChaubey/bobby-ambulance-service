        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
           <h2 className="text-4xl md:text-5xl font-bold text-[#3f9ad1] mb-4 font-serif">
...
<p className="text-lg text-gray-600 mb-6 leading-relaxed">
  Today, we stand as a reliable name in emergency medical transport and dignified body preservation, proudly serving families with care, responsibility, and trust.
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-gradient-to-br from-[#3f9ad1]/10 to-red-700/10 rounded-2xl p-8 border border-[#3f9ad1]/20">
  ...
  <div>
    ...
    <p className="text-gray-600">
      ...
      {/* Stats Counter - Updated with Brand Colors */}
   <section ref={counterRef} className="relative py-16 overflow-hidden">
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-6">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
      ...
      {/* Values Grid - Updated with Brand Colors */}
            ...
            {values.map((value, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.1 }}
                  className="bg-gray-50 rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 group"
                >
                  <div className="w-14 h-14 bg-blue-100 rounded-lg flex items-center justify-center mb-5 group-hover:bg-[#3f9ad1] transition-colors">
                    <Icon className="w-7 h-7 text-[#3f9ad1] group-hover:text-white transition-colors" />
                  </div>
      ...
      {/* Testimonials - Updated with Brand Colors */}
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="absolute -top-4 -right-4 w-12 h-12 bg-[#3f9ad1] rounded-full flex items-center justify-center">
